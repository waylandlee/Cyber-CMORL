...
The following result blocks are already wired into [`main.tex`](/home/waylandlee/CMORL2/Cyber-CMORL/paper/main.tex):

- Table A from [`set_quality_table.tex`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/outputs/paper_table_a/set_quality_table.tex)
- Table B from [`deployment_table.tex`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/outputs/paper_table_b/deployment_table.tex)
- Figure C from [`preference_coverage.png`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/outputs/paper_figure_c/preference_coverage.png)
- Figure D from [`tight_feasible_set_quality.png`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/outputs/fair_compare_eval/aggregated/tight_feasible_set_quality.png)
- Appendix attacker-shift table from [`attacker_shift_summary.tex`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/outputs/paper_appendix/attacker_shift/attacker_shift_summary.tex)
- Appendix business/cost semantics table from [`business_cost_semantics.tex`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/outputs/paper_appendix/business_cost_semantics/business_cost_semantics.tex)
- Appendix business/cost semantics figure from [`business_cost_semantics.png`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/outputs/paper_appendix/business_cost_semantics/business_cost_semantics.png)
...
- [`reevaluated_tight_feasible_set_summary.json`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/outputs/fair_compare_eval/aggregated/reevaluated_tight_feasible_set_summary.json)
...
- live status files such as [`paper_5seed_runner/status.json`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/outputs/paper_5seed_runner/status.json)
- run manifests such as [`paper_5seed_runner/run_manifest.json`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/outputs/paper_5seed_runner/run_manifest.json)
- raw per-preference assignment dumps such as [`per_preference_assignment.csv`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/outputs/paper_figure_c/per_preference_assignment.csv)
...
- [`ARTIFACT_README.md`](/home/waylandlee/CMORL2/Cyber-CMORL/paper/ARTIFACT_README.md)
- [`main.tex`](/home/waylandlee/CMORL2/Cyber-CMORL/paper/main.tex)
- [`refs.bib`](/home/waylandlee/CMORL2/Cyber-CMORL/paper/refs.bib)
...
- [`export_locked_tables.py`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/export_locked_tables.py)
- [`export_preference_coverage.py`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/export_preference_coverage.py)
- [`export_tight_feasible_set.py`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/export_tight_feasible_set.py)
- [`export_business_cost_semantics.py`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/export_business_cost_semantics.py)
- [`export_attacker_shift_summary.py`](/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/export_attacker_shift_summary.py)
- the canonical paper-facing outputs listed in [`ARTIFACT_README.md`](/home/waylandlee/CMORL2/Cyber-CMORL/paper/ARTIFACT_README.md)
