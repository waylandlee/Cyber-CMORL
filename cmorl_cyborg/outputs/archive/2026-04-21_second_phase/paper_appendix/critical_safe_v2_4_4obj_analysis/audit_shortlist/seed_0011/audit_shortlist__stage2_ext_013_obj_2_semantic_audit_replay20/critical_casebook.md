...
- Basic info: `episode_id=episode_006` `env_idx=1` `env_seed=1017` `risk_tier=Tier 1 Near-Miss`
- Returns: `security=-170.6000` `business=-27.9150` `cost=-19.0000`
...
- `Restore -> Enterprise1`: `2021` containment steps
- `Restore -> Enterprise0`: `1739` containment steps
