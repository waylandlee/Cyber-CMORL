# Semantic Risk Summary: stage2_ext_015_obj_2

- Candidate: `audit_shortlist` / `stage2_ext_015_obj_2`
- Trace dir: `/home/waylandlee/CMORL2/Cyber-CMORL/cmorl_cyborg/outputs/paper_appendix/critical_safe_v2_4_4obj_analysis/audit_shortlist/seed_0007/trace/ours_stage2_fair_critical_safe_v2_4_4obj/seed_0007/audit_shortlist__stage2_ext_015_obj_2`
- Tight thresholds: `business >= -125.0` `cost >= -22.0`
- Audit verdict: `Green`

## Core Metrics

- Mean returns: `security=-170.1025` `business=-28.8167` `cost=-23.4961`
- Mean `critical_host_safety`: `0.0000`
- Env-run feasible rate: `0.0000`
- Per-env violation rate: `business=0.0000` `cost=1.0000`
