...
- `decoy`: `1966` pre-critical steps
- `restore`: `902` pre-critical steps
- `remove`: `319` pre-critical steps
- `analyse`: `243` pre-critical steps
- `other`: `112` pre-critical steps

### Pre-critical compromised-target recovery counts

- `Restore -> Op_Server0`: `313` containment steps
- `Restore -> Enterprise2`: `166` containment steps
- `Analyse -> Enterprise2`: `43` containment steps
- `Restore -> Enterprise0`: `31` containment steps
- `Remove -> Enterprise1`: `16` containment steps

### Pre-critical no-containment top actions

- `DecoyVsftpd -> Op_Server0`: `139` no-containment steps
- `DecoySmss -> User4`: `133` no-containment steps
- `Restore -> Op_Server0`: `130` no-containment steps
- `DecoySmss -> Enterprise1`: `114` no-containment steps
- `Monitor -> -`: `105` no-containment steps
