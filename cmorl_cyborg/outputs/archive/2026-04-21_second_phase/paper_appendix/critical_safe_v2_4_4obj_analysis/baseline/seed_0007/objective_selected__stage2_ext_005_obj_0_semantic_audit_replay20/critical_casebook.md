...
- `decoy`: `5971` critical-present steps
- `remove`: `2256` critical-present steps
- `restore`: `1913` critical-present steps
- `analyse`: `445` critical-present steps
- `other`: `169` critical-present steps

### Critical-step recovery counts

- `Restore -> Enterprise2`: `231` recovery steps
- `Restore -> Enterprise1`: `74` recovery steps
- `Restore -> Enterprise0`: `54` recovery steps
- `Restore -> User2`: `21` recovery steps
- `Restore -> User4`: `2` recovery steps

### Critical-step no-recovery top actions

- `Remove -> Enterprise1`: `1801` no-recovery steps
- `DecoyFemitter -> Enterprise2`: `1386` no-recovery steps
- `DecoySSHD -> User3`: `1062` no-recovery steps
- `Restore -> Enterprise1`: `583` no-recovery steps
- `DecoySvchost -> Defender`: `530` no-recovery steps

## Pre-critical containment summary

### Pre-critical top action families

- `decoy`: `1672` pre-critical steps
- `restore`: `917` pre-critical steps
- `remove`: `574` pre-critical steps
- `analyse`: `127` pre-critical steps
- `other`: `44` pre-critical steps

### Pre-critical compromised-target recovery counts

- `Restore -> Op_Server0`: `244` containment steps
- `Remove -> Enterprise1`: `207` containment steps
- `Restore -> Enterprise1`: `82` containment steps
- `Restore -> Enterprise2`: `69` containment steps
- `Restore -> Enterprise0`: `33` containment steps

### Pre-critical no-containment top actions

- `DecoyFemitter -> Enterprise2`: `378` no-containment steps
- `DecoySSHD -> User3`: `291` no-containment steps
- `Remove -> Enterprise1`: `259` no-containment steps
- `DecoySvchost -> Defender`: `150` no-containment steps
- `Restore -> Enterprise2`: `129` no-containment steps
