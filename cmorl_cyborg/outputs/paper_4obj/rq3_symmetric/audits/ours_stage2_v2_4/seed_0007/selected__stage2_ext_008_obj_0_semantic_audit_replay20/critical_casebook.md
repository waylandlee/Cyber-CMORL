...
- Basic info: `episode_id=episode_012` `env_idx=4` `env_seed=4019` `risk_tier=Tier 1 Near-Miss`
- Returns: `security=-170.6000` `business=-28.6525` `cost=-23.3800`
...
- step 99: Blue `Analyse` -> `Enterprise0`; Red `ExploitRemoteService` -> `-`; new=Enterprise0; recovered=-; critical_after=-
...
- `restore`: `7514` pre-critical steps

### Pre-critical compromised-target recovery counts

- `Restore -> Enterprise1`: `4418` containment steps
- `Restore -> Enterprise0`: `3096` containment steps
