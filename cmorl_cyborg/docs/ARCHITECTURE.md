...
- [env.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/env.py)
...
- [scenario_profiles.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/scenario_profiles.py)
  读取 `Scenario2.yaml` 这类 profile
- [config.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/config.py)
  所有训练、评估、主表配置 dataclass

## 训练链路

- [train_stage1.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/train_stage1.py)
  复用 `cmorl_minicage.train_stage1`，但环境替换成 `CybORGMORLEnv`
- [train_stage2.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/train_stage2.py)
  复用 `cmorl_minicage.train_stage2`，环境替换成 `CybORGMORLEnv`
- [baselines.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/baselines.py)
  `weighted_sum`、`stage1_only`、`single_objective` 等 baseline 入口
- [train_pref_conditioned_ppo.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/train_pref_conditioned_ppo.py)
  preference-conditioned PPO 入口
- [train_lagrangian_ppo.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/train_lagrangian_ppo.py)
  Lagrangian PPO 入口
- [train_pcn.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/train_pcn.py)
  PCN 入口

## 评估链路

- [evaluate.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/evaluate.py)
  buffer 方法主评估
- [evaluate_conditioned.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/evaluate_conditioned.py)
...
- [evaluate_constraints.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/evaluate_constraints.py)
  表 B 约束评估
- [compare_suite.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/compare_suite.py)
...
- [export_tables.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/export_tables.py)
  导出 CSV / TEX
- [paper_plots.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/paper_plots.py)
  绘制正式图

## 正式运行编排

- [week2_formal_runner.py](/home/waylandlee/Cyber-CMORL/CybORG_plus_plus/cmorl_cyborg/week2_formal_runner.py)
  组织 `3-seed` 正式运行
- 输出状态：
