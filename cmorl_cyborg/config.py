...
class Stage1Config:
    ...
    stage1_protocol_name: str = "cyborg_migration"
...
class Stage2Config:
    ...
    ipo: IPOHyperConfig = field(
        default_factory=lambda: IPOHyperConfig(
            barrier_coef=20.0, beta_mode="dynamic", beta_min=0.85, beta_max=0.95
        )
    )
...
class PreferenceConditionedPPOConfig:
    ...
    output_dir: str = "cmorl_cyborg/outputs/paper_table_a/preference_conditioned_ppo"
...
class LagrangianPPOConfig:
    seed: int = 23
    total_timesteps: int = 98304
    output_dir: str = "cmorl_cyborg/outputs/paper_table_b/lagrangian_ppo"
    stage1_buffer: str = ""
    thresholds_path: str = ""
    dual_lr: float = 0.05
    clip_param: float = 0.2
...
class PCNConfig:
    seed: int = 29
    total_timesteps: int = 98304
    output_dir: str = "cmorl_cyborg/outputs/paper_appendix/pcn"
...
class CompareSuiteConfig:
    output_dir: str = "cmorl_cyborg/outputs/paper_table_a"
...
class ExportTablesConfig:
    ...
    output_dir: str = "cmorl_cyborg/outputs/paper_tables"
...
DEFAULT_EVALUATE_CONFIG = CONFIG_DIR / "smoke" / "evaluate_smoke.yaml"
...
DEFAULT_PREFERENCE_CONDITIONED_PPO_CONFIG = CONFIG_DIR / "paper" / "pref_cond_ppo.yaml"
DEFAULT_LAGRANGIAN_PPO_CONFIG = CONFIG_DIR / "paper" / "lagrangian_ppo.yaml"
